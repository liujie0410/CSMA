...
void VoicePacket::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimUnpacking(b,this->aim_id);
...
int VoicePacket::getAim_id() const
{
    return this->aim_id;
}

void VoicePacket::setAim_id(int aim_id)
{
    this->aim_id = aim_id;
}

double VoicePacket::getSend_time() const
{
    return this->send_time;
}

void VoicePacket::setSend_time(double send_time)
{
...
int VoicePacketDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='a' && strcmp(fieldName, "aim_id")==0) return base+1;
...
std::string VoicePacketDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 1: return long2string(pp->getAim_id());
        case 2: return double2string(pp->getSend_time());
        default: return "";
    }
}
...
bool VoicePacketDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 1: pp->setAim_id(string2long(value)); return true;
        case 2: pp->setSend_time(string2double(value)); return true;
